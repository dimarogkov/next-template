...
const AlertWrapper: FC<Props> = forwardRef<HTMLDivElement, Props>(
...
const AlertTitle: FC<Props> = forwardRef<HTMLParagraphElement, Props>(
...
const AlertDescription: FC<Props> = forwardRef<HTMLParagraphElement, Props>(
    ({ variant = 'default', className = '', ...props }, ref) => {
